...
export declare class VerificationError extends Error implements VerificationError {
    code: string;
    statusCode: number;
    constructor(message: string, code?: string, statusCode?: number);
}
export declare class BiometricError extends Error implements VerificationError {
    code: string;
    statusCode: number;
    constructor(message: string, code?: string, statusCode?: number);
}
export declare class DocumentError extends Error implements VerificationError {
    code: string;
    statusCode: number;
    constructor(message: string, code?: string, statusCode?: number);
}
export declare class DuplicateError extends Error implements VerificationError {
    code: string;
    statusCode: number;
    constructor(message: string, code?: string, statusCode?: number);
}
