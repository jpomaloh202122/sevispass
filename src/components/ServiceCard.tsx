...
export default function ServiceCard({ title, description, icon, href, status = 'active' }: ServiceCardProps) {
  ...
  return (
    <a
      href={href}
      className="group block p-6 bg-white rounded-lg border-2 border-red-600 shadow-sm hover:shadow-md hover:border-red-700 transition-all duration-200"
    >
      <div className="flex items-start space-x-4">
        <div className="flex-shrink-0">
          <div className="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center text-red-600 group-hover:bg-red-200 transition-colors">
            {icon}
          </div>
        </div>
